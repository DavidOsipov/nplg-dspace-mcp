...
def test_phase_three_mutation_policies_are_closed_and_test_selected() -> None:
    ...
    assert (
        "nplg_mcp.config.x__canonical_alpic_gateway_host"
        in task_thirteen_functions["src/nplg_mcp/config.py"]
    )
    assert {
        ...
        "src/nplg_mcp/parsers.py": frozenset(
            {
                ...
                "x__has_jspui_results_panel_class",
